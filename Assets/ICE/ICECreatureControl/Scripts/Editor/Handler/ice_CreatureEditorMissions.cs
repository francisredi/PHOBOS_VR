	...
	{	
		...
		private static void DrawMissionOutpost( ICECreatureControl _control ){
			...
			ICEEditorLayout.BeginHorizontal();
				_control.Display.FoldoutMissionOutpost = ICEEditorLayout.Foldout( _control.Display.FoldoutMissionOutpost, "Outpost Mission" );

			if (GUILayout.Button("SAVE", ICEEditorStyle.ButtonMiddle ))
				CreatureIO.SaveMissionOutpostToFile( _control.Creature.Missions.Outpost, _control.gameObject.name );
			if (GUILayout.Button("LOAD", ICEEditorStyle.ButtonMiddle ))
				_control.Creature.Missions.Outpost = CreatureIO.LoadMissionOutpostFromFile( _control.Creature.Missions.Outpost );

				_control.Creature.Missions.Outpost.Enabled = ICEEditorLayout.ButtonCheck( "ENABLE","", _control.Creature.Missions.Outpost.Enabled, ICEEditorStyle.ButtonMiddle );
			...
			EditorGUI.BeginDisabledGroup ( _control.Creature.Missions.Outpost.Enabled == false);				
				EditorSharedTools.DrawTarget( _control, _control.Creature.Missions.Outpost.Target, "Target", Info.MISSION_OUTPOST_TARGET );
				...
				EditorGUI.indentLevel++;		
					...
					EditorGUI.BeginDisabledGroup( _control.Creature.Missions.Outpost.Target.Move.RandomRange == 0 );
		...
		private static void DrawMissionEscort( ICECreatureControl _control  ){
			...
			ICEEditorLayout.BeginHorizontal();
				...
				_control.Creature.Missions.Escort.Enabled = ICEEditorLayout.ButtonCheck( "ENABLE","", _control.Creature.Missions.Escort.Enabled, ICEEditorStyle.ButtonMiddle );
			...
			EditorGUI.BeginDisabledGroup ( _control.Creature.Missions.Escort.Enabled == false);
				...
				EditorSharedTools.DrawTarget( _control, _control.Creature.Missions.Escort.Target, "Target", Info.MISSION_ESCORT_TARGET );
		...
		private static void DrawMissionPatrol( ICECreatureControl _control )
		{
			...
			//HEADER BEGIN
			ICEEditorLayout.BeginHorizontal();
				_control.Display.FoldoutMissionPatrol = ICEEditorLayout.Foldout( _control.Display.FoldoutMissionPatrol, "Patrol Mission" );
				if (GUILayout.Button("SAVE", ICEEditorStyle.ButtonMiddle ))
					CreatureIO.SaveMissionPatrolToFile( _control.Creature.Missions.Patrol, _control.gameObject.name );
				if (GUILayout.Button("LOAD", ICEEditorStyle.ButtonMiddle ))
					_control.Creature.Missions.Patrol = CreatureIO.LoadMissionPatrolFromFile( _control.Creature.Missions.Patrol );			
				_control.Creature.Missions.Patrol.Enabled = ICEEditorLayout.ButtonCheck( "ENABLE","", _control.Creature.Missions.Patrol.Enabled, ICEEditorStyle.ButtonMiddle );
...
*/
		...
		private static void DrawMissionPatrolWaypoint( ICECreatureControl _control, int _index )
		{
			...
			EditorGUI.BeginDisabledGroup ( _waypoint.Enabled == false);				
				EditorGUI.indentLevel++;				
					EditorSharedTools.DrawTarget( _control, (TargetObject)_waypoint, "Target", Info.MISSION_PATROL_TARGET );
