...
namespace ICE.Creatures.EditorHandler
{
	...
	{	
		public static void Print( ICECreatureControl _control ){
			...
			_info += "    Lateral Variance: " + _control.Creature.Move.CurrentMove.MoveDeviationVariance + " (default: " + _control.Creature.Move.DefaultMove.MoveDeviationVariance + ")\n\n";
