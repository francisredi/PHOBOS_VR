	...
	namespace Creatures
	{
		namespace Objects
		{
			...
			public class MissionsObject : System.Object
			{
				...
				public TargetObject FindNextTargetInRange( Transform transform, float range )
				{
					...
					for ( int i = 0; i < hits.Length; i++ ) 
					{
						...
						if( hit.transform.gameObject.GetComponent<MeshFilter>() )
						{
							...
							if ( _obj != null ) 
							{
								...
								float _dist = GraphicTools.GetHorizontalDistance( transform.position, _obj.transform.position );
					...
					if( _object != null )
					{
						...
						Outpost.Target.Move.StopDistance = 2;
						Outpost.Target.Move.RandomRange = _distance;
			...
			public class OutpostObject : MissionObject
			{
				...
				{
					if( Enabled == true && Target.IsValid )
						return true;
					else
						return false;
				}
				...
				{
					if( Target.GetBestTargetGameObject( _owner ) == null || TargetReady() == false || _owner == null || _creature == null || _creature.Behaviour == null )
						return null;
					...
					else if( Target.Move.RandomRange > 0 )
...
*/
			...
			public class PatrolObject : MissionObject
			{
				...
				public bool TargetReady()
				{
					if( Enabled == true && hasWaypoints == true && Target != null && Target.IsValid )
						return true;
					else
						return false;
				}
				...
				public TargetObject PrepareTarget( GameObject _owner, CreatureObject _creature )
				{
					if( Target == null || Target.GetBestTargetGameObject( _owner ) == null || TargetReady() == false || _owner == null || _creature == null || _creature.Behaviour == null )
						return null;
