...
*/
		...
		{ 
			...
			{
				Vector3 _pos_1 = GraphicTools.GetDirectionPosition( _target, _angle, _radius );
				Vector3 _pos_2 = GraphicTools.GetDirectionPosition( _target, _angle, _radius + 1 );
		...
		{ 
			...
			Vector3 _center_pos = GraphicTools.GetDirectionPosition( _target, 0, _radius + ( _radius / 10 ) );
			Vector3 _left_pos = GraphicTools.GetDirectionPosition( _target, _left, _radius );
			Vector3 _right_pos = GraphicTools.GetDirectionPosition( _target, _right, _radius );
			...
			{
				Vector3 _pos = GraphicTools.GetDirectionPosition( _target, _angle, _radius );
				_pos.y = _level;
		...
		{ 
			float _angle = GraphicTools.GetOffsetAngle( _creature - _center );
